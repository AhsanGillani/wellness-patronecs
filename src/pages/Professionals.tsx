...
const Professionals = () => {
  ...
  const filteredProfessionals = useMemo(() => {
    ...
    if (selectedSpecialty) {
      filtered = filtered.filter(p => 
        p.title === selectedSpecialty || p.specialization === selectedSpecialty
      );
    }
    ...
    if (maxPrice > 0) {
      filtered = filtered.filter(p => {
        const price = p.price_per_session !== null && p.price_per_session !== undefined ? p.price_per_session / 100 : 50;
    ...
    switch (sortBy) {
      ...
      case "price-low-high":
        filtered.sort((a, b) => {
          const priceA = a.price_per_session !== null && a.price_per_session !== undefined ? a.price_per_session / 100 : 50;
          const priceB = b.price_per_session !== null && b.price_per_session !== undefined ? b.price_per_session / 100 : 50;
    ...
    return filtered;
  }, [professionals, searchTerm, location, selectedSpecialty, minRating, maxPrice, sortBy]);
  ...
  const hasActiveFilters = searchTerm || location || selectedSpecialty || minRating > 0 || maxPrice > 0;
            ...
            <div className="space-y-3">
              ...
              {hasActiveFilters && (
                <div className="text-xs text-slate-500 text-center">
                  {filteredProfessionals.length} of {professionals?.length || 0} professionals
                </div>
              )}
              {!hasActiveFilters && professionals && professionals.length > 0 && (
                <div className="text-xs text-slate-500 text-center">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
              <div>
                ...
                <p className="mt-1 text-slate-600">
                  {hasActiveFilters 
                    ? `Found ${filteredProfessionals.length} professional${filteredProfessionals.length !== 1 ? 's' : ''} matching your criteria`
            ...
            <div className="mt-6 grid gap-6">
              {loading ? (
                <div className="space-y-6">
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="rounded-2xl border bg-white p-5 sm:p-6 animate-pulse">
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-semibold text-slate-900 mb-2">Unable to Load Professionals</h3>
                ...
                <div className="text-center py-16">
                  ...
                  <h3 className="text-lg font-semibold text-slate-900 mb-2">
                    {hasActiveFilters ? 'No professionals match your filters' : 'No Professionals Available Yet'}
                  </h3>
                  ...
                  <div className="text-sm text-slate-500 mb-6">
                    In the meantime, explore our <a href="/services" className="text-violet-600 hover:text-violet-700 underline">services</a> and <a href="/events" className="text-violet-600 hover:text-violet-700 underline">events</a>.
                  </div>
                  <div className="flex gap-3 justify-center">
                ...
                pagedProfessionals?.map((p) => {
                  return (
                    <div key={p.id} className="rounded-2xl border bg-white p-5 sm:p-6">
                      <div className="flex flex-col sm:flex-row sm:items-center gap-5">
                        <img 
                          src={p.avatar_url || "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=400"} 
                          alt={p.name} 
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <div className="mt-1 flex items-center gap-2">
                            ...
                            <div className="text-sm text-slate-600">{p.rating} ({p.reviews})</div>
                          </div>
                        ...
                        <div className="w-full sm:w-auto sm:text-right">
                          ...
                          <div className="text-base font-semibold text-slate-900">
                            ${p.price_per_session !== null && p.price_per_session !== undefined ? (p.price_per_session / 100).toFixed(0) : '50'}
                          </div>
